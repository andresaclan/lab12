...
public class FamilyTree {
    ...
    private static class TreeNode<T> {
        ...
        TreeNode<T> getNodeWithName(String targetName) {
            ...
            for (TreeNode<T> child : children) {
                ...
                TreeNode<T> n = child.getNodeWithName(targetName);
                if (n != null) return n;
            }
    ...
    private void addLine(String line) throws TreeException {
        ...
        if (root == null)
			...
			if (parentNode == null) throw new TreeException("\"" + parent + "\" does not exist in existing tree.");
        }
    ...
    TreeNode<String> getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
        ...
        if (node1 == null)
			...
			throw new TreeException("No ancestor with name \"" + name1 + "\" in tree.");
        TreeNode<String> node2 = root.getNodeWithName(name2);	// node whose name is name2
        if (node2 == null)
			//Throw TreeException with a useful message
			throw new TreeException("No ancestor with name \"" + name2 + "\" in tree.");
